...
class Settings extends EventEmitter {
  ...
  _ensureSettings() {
    ...
    try {
      jsonfile.readFileSync(settingsFilePath, { reviver: this._deserialize });
    } catch (err) {
      try {
        jsonfile.writeFileSync(settingsFilePath, { spaces: 2, replacer: this._serialize });
      } catch (err) {
  ...
  _writeSettings(obj = {}, opts = {}) {
    ...
    try {
      jsonfile.writeFileSync(this._getSettingsFilePath(), obj, { spaces: 2, replacer: this._serialize });
    } catch (err) {
  ...
  _readSettings() {
    ...
    try {
      return jsonfile.readFileSync(this._getSettingsFilePath(), { reviver: this._deserialize });
    } catch (err) {
